...
export const metadata: Metadata = {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Drova Studio - AI Video Creation for Creators",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  twitter: {
    ...
    title: "Drova Studio | AI Video Creation for Creators",
    description: "Create videos 10x faster with AI avatars and voice cloning. The unfair advantage for creators.",
